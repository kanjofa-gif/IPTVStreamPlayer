...
public final class PlaylistDao_Impl implements PlaylistDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfSelectPlaylist;
  ...
  public PlaylistDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPlaylist = new EntityInsertionAdapter<Playlist>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `playlists` (`id`,`name`,`url`,`username`,`password`,`isSelected`,`addedAt`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfPlaylist = new EntityDeletionOrUpdateAdapter<Playlist>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `playlists` SET `id` = ?,`name` = ?,`url` = ?,`username` = ?,`password` = ?,`isSelected` = ?,`addedAt` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfClearAllSelections = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "UPDATE playlists SET isSelected = 0";
        return _query;
      }
    };
    this.__preparedStmtOfSelectPlaylist = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE playlists SET isSelected = 1 WHERE id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object selectPlaylist(final int id, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfSelectPlaylist.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfSelectPlaylist.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  public Flow<List<Playlist>> getAllPlaylists() {
    final String _sql = "SELECT * FROM playlists ORDER BY addedAt DESC";
      ...
      public List<Playlist> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Playlist(_tmpId,_tmpName,_tmpUrl,_tmpUsername,_tmpPassword,_tmpIsSelected,_tmpAddedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getSelectedPlaylist(final Continuation<? super Playlist> $completion) {
    final String _sql = "SELECT * FROM playlists WHERE isSelected = 1 LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
      ...
      public Playlist call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpAddedAt;
            _tmpAddedAt = _cursor.getLong(_cursorIndexOfAddedAt);
            _result = new Playlist(_tmpId,_tmpName,_tmpUrl,_tmpUsername,_tmpPassword,_tmpIsSelected,_tmpAddedAt);
          } else {
            _result = null;
          }
          return _result;
